...
def Topologi():
	...
	r1.cmd('ifconfig r1-eth0 192.0.0.1 255.255.255.252')
		
	r1.cmd('ifconfig r1-eth1 1')
	r1.cmd('ifconfig r1-eth0 192.0.0.21 255.255.255.252')
	
	r2 = net.addHost('r2', ip='192.0.0.2/30')
	r2.cmd('ifconfig r2-eth0 0')
	r2.cmd('ifconfig r2-eth0 192.0.0.1 255.255.255.252')
		
	r2.cmd('ifconfig r2-eth1 1')
	r2.cmd('ifconfig r2-eth0 192.0.0.21 255.255.255.252')
	
	r3 = net.addHost('r3', ip='192.0.0.2/30')
	r3.cmd('ifconfig r3-eth0 0')
	r3.cmd('ifconfig r3-eth0 192.0.0.1 255.255.255.252')
		
	r3.cmd('ifconfig r3-eth1 1')
	r3.cmd('ifconfig r3-eth0 192.0.0.21 255.255.255.252')
	
	r4 = net.addHost('r4', ip='192.0.0.2/30')
	r4.cmd('ifconfig r4-eth0 0')
	r4.cmd('ifconfig r4-eth0 192.0.0.1 255.255.255.252')
		
	r4.cmd('ifconfig r4-eth1 1')
	r4.cmd('ifconfig r4-eth0 192.0.0.21 255.255.255.252')
